...
$sql1=mysql_query("select * from case_details where caseDate='$date' and  status !='closed' limit 1") or die(mysql_error());
...
<side id="accusor1">
ACCUSED'S SIDE
 <table class="table table-condensed" style="Border: 1px solid magenta;font-size:10;" width="300" >
	   <thead>
	   <tr>
...
$sql1=mysql_query("select * from case_details where caseDate='$date' and status !='closed' and (Clerk_id='$national_id' or prosecutor='$national_id')");
...
<br/><br/><br/>
 ...
 <br>
	...
	<br>	
<p>	 <span id="spann1" style="font-size: 17;"></span></p>
</div> 
