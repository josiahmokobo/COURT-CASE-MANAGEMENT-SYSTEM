	...
	$.alerts = {
		...
		_show: function(title, msg, value, type, callback) {
			...
			switch( type ) {
				...
				break;
				case 'prompt':
					$("#popup_message").append('<br /><input type="text" size="30" id="popup_prompt" />').after('<div id="popup_panel"><button type="button"  id="popup_ok" class="cancel">' + $.alerts.okButton + '</button> <button type="button"  id="popup_cancel" class="cancel">' + $.alerts.cancelButton + '</button></div>');
